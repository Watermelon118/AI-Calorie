...
| 功能 | 说明 | 状态 |
| --- | --- | --- |
| 今日总览 | 展示今日摄入热量、目标热量、剩余额度和三餐概览 | 静态页基本完成 |
| 餐食记录 | 支持记录早餐、午餐、晚餐及加餐的食物、热量、时间和备注 | 未开始 |
...
| 页面 | 路由建议 | 主要职责 | 状态 |
| --- | --- | --- | --- |
| 今日 | `/today` | 今日热量摘要、营养摄入和今日记录列表 | 静态页基本完成 |
| 新增/编辑餐食 | `/meals/new`、`/meals/:id/edit` | 表单录入与编辑餐食记录 | 未开始 |
